...
//Define aleat�riamente uma dire��o para a bola
...
//Normaliza a dire��o para valores entre -60 e 60 ou entre 120 e -120
...
//Atualiza a posi��o da bola de acordo com sua dire��o e velocidade
function moveBall(ball) {
	ball.x += ball.speed * Math.cos(ball.dir)
	ball.y -= ball.speed * Math.sin(ball.dir)
}

//Atualiza a posi��o da barra de acordo com a dire��o escolhida pelo jogador
...
//Trata colis�es, caso haja alguma
function checkCollision() {
	calcPaddleSpeed()

	//Colis�o com a parede inferior ou superior
	if (ball.y <= ball.r) {
		//Normaliza a posi��o da bola
		ball.y = ball.r
		ball.dir = -ball.dir
	}
	...
	//Atualiza o c�lculo da velocidade das barras
	...
	//Simula a colis�o da bola com a barra especificada
	function collidePaddle(paddle) {
		var vx = -ball.speed * Math.cos(ball.dir)
		var vy = ball.speed * Math.sin(ball.dir) + paddle.speed
		//Calcula o �ngulo do vetor velocidade resultante, corrigindo a defasagem de 180 graus da fun��o Math.atan
		ball.dir = Math.atan(vy/vx) + (vx < 0 ? RAD[180] : RAD[0])
		//Calcula o m�dulo do vetor velocidade resultante
